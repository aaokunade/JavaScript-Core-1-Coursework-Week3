...
*/
function getTransportModes(jrnyArr) {
  let journey = jrnyArr.slice(1, jrnyArr.length);
  return journey;
}
...
*/
function isAccessibleByTransportMode(transArr, transMode) {
  return transArr.includes(transMode);
}
