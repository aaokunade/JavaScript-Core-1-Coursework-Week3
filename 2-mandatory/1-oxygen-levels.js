...
function safeLevels(oxygenLevels) {
  ...
  function modifyOxyLv (oxyLv){
    let rmvPcent = oxyLv.substring(0, oxyLv.length-1);
    let numOxy = parseFloat(rmvPcent);
    return (numOxy > 19.5) && (numOxy < 23.5)
  }

  return oxygenLevels.find(modifyOxyLv)
}
